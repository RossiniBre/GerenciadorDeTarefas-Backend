...
public class LoginUseCaseTest {
    ...
    void shouldLoginSuccessfully(){
        ...
        //Act
        User registeredUser = registerUseCase.execute("joao123@example.com", "joao123", "minhaSenha123", "Owner");
    ...
    void shouldThrowExceptionWhenPasswordIsIncorrect(){
        ...
        LoginUseCase loginUseCase = new LoginUseCase(repo, hasher);
        RegisterUserUseCase registerUseCase = new RegisterUserUseCase(repo, hasher);
        registerUseCase.execute("joao123@example.com", "joao123", "minhaSenha123", "Owner");
